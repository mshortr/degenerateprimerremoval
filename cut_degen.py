...
fastafile = sys.argv[1] #This is the input fasta file
...
# Here is the command for the test:  python cut_degen.py 'test.fasta' 'GAACWAYWYCT' 'True' 'True'  '5' 'test'
